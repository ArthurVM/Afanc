...
def makeJson(resultsdict, pct_threshold, num_threshold, output_prefix, reportsDir, dbdict):
    ...
    for taxa_level, taxa_box in resultsdict.items():
        ...
        for taxa in taxa_box:
            json_dict[tl].append(taxa.makeJsonLine(dbdict))
...
def parseK2reportMain(args, dbdict):
    ...
    makeJson(resultsdict, args.pct_threshold, args.num_threshold, args.output_prefix, args.reportsDir, dbdict)
